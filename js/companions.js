...
const PET_DATA={
  // Same visual logic as classes: similar perceived size, feet on the carpet.
  tiger:{label:'Tigre glacial',image:'assets/pet-tiger.png',height:'86%',left:'50%',bottom:'0%'},
  gelapuf:{label:'Gélapuf',image:'assets/pet-gelapuf.png',height:'84%',left:'50%',bottom:'0%'},
  deer:{label:'Biche étoilée',image:'assets/pet-deer.png',height:'90%',left:'50%',bottom:'0%'}
};
