...
const PET_DATA={
  // all centered on the carpet, feet grounded, similar visual scale
  tiger:{label:'Tigre glacial',image:'assets/pet-tiger.png',height:'79%',left:'50%',bottom:'0%'},
  gelapuf:{label:'Gélapuf',image:'assets/pet-gelapuf.png',height:'77%',left:'50%',bottom:'0%'},
  deer:{label:'Biche étoilée',image:'assets/pet-deer.png',height:'96%',left:'50%',bottom:'0%'}
};
