...
const CLASS_DATA={
  // Tuned so all heroes stand on the carpet and keep a close visual scale.
  knight:{label:'Chevalier',image:'assets/class-knight.png',height:'96%',left:'50%',bottom:'-2.2%'},
  hunter:{label:'Chasseur',image:'assets/class-hunter.png',height:'95%',left:'49.5%',bottom:'-2.4%'},
  wizard:{label:'Sorcier',image:'assets/class-wizard.png',height:'98%',left:'50.5%',bottom:'-2.0%'},
  sage:{label:'Sage',image:'assets/class-sage.png',height:'97%',left:'50.3%',bottom:'-2.1%'}
};
